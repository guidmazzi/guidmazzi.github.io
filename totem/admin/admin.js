...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sections = [
        ...
        {
            button: document.querySelector('.relatorios'),
            target: document.getElementById('vendas'),
            button2: document.querySelector('.logo2'),
        }
    ];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function mostrarProdutos(vendaId, container) {
        ...
        container.innerHTML = `<h3>ID Venda: ${vendaId}</h3>`;
    ...
    for (const vendaId in simulatedResponse) {
        ...
        button.classList.add('venda-button');
        button.innerText = `Venda Número ${vendaId}`;
        ...
        vendaContainer.appendChild(button);
